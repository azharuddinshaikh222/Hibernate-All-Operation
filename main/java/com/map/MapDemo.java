...
public class MapDemo {
	public static void main(String[] args) {
		...
		/*
		 * //creating question Question q1 = new Question(); q1.setQuestionId(1212);
		 * q1.setQuestion("what is java?"); // creating answer Answer answer = new
		 * Answer(); answer.setAnswerId(343);
		 * answer.setAnswer("java is a programming language"); answer.setQuestion(q1);
		 * 
